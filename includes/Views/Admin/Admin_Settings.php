...
class Admin_Settings extends \WC_Settings_Page {
    ...
    public static function create_plugin_settings_banner() {
        ...
        $dps_upsell .= "&nbsp;<a href='https://chwazidatetime.com' target='_blank'>{$here}</a>";
...
HTML;
    ...
    private function create_store_locations_settings_fields() {
        ...
        $lpac_settings[] = array(
            'name'     => __( 'Allow Searching of Store Locations', 'map-location-picker-at-checkout-for-woocommerce' ),
            'desc'     => __( 'Yes', 'map-location-picker-at-checkout-for-woocommerce' ),
            'desc_tip' => __( 'Enabling this option will add a search box to the store locations dropdown field, allowing customers to search for store locations.', 'map-location-picker-at-checkout-for-woocommerce' ),
            'id'       => 'lpac_enable_search_in_store_locations',
            'type'     => 'checkbox',
        );
        $lpac_settings[] = array(
    ...
    private function output_map_visibility_rules_order() {
        ...
        ?></p>
				<?php 
        wp_nonce_field( 'lpac_map_visibility_rules_order', 'lpac-rules-order-nonce' );
        ?>
				<thead>
				<tr>
